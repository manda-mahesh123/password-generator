...
op_box=tkinter.Listbox(root,height=10,width=40,font=("Times New Roman",20))
op_box.grid(row=0,column=0,rowspan=2,columnspan=5)
len_label=tkinter.Label(root,text="Enter the Length of password ",font=("Calibri",12,"roman"),background="white",foreground="black")
...
num_box=tkinter.Checkbutton(root,text="Numericals",variable=state_1)
num_box.grid(row=4,column=1)
label1=tkinter.Label(root,text="",background="white")
label1.grid(row=5,column=0)
special_box=tkinter.Checkbutton(root,text="Special Characters",variable=state_2)
special_box.grid(row=6,column=1)
label2=tkinter.Label(root,text="",background="white")
label2.grid(row=7,column=0)
gen_button=tkinter.Button(root,text="Generate",height=2,width=10,font=("arial",10,"bold"),command=password)
